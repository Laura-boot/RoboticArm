/*******************************************************************************
* Controle web de um braco robotico com a Vespa por WebSocket
* (v1.0 - 26/10/2021)
*
* Copyright 2021 RoboCore.
* Interface web escrita por Lenz (26/10/2021).
* Programa do ESP escrito por Francois (26/10/2021).
*
...
<body style="height: 100%;  font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ;">
    ...
    <div style="color:rgb(128, 128, 128); font-size: medium; text-align: left; width: 300px; border: 0px solid red; position: absolute; top: 0px; left: 0px; display: none;">
    ...
    <div style="display: table; width:100%; height: calc(100% - 50px); border: 0px solid green;">
        <div style="display: table-cell; vertical-align: middle;">
            <div class="slidecontainer" style="display: flex; align-items: center; justify-content: space-evenly; align-content: center; flex-direction: column; flex-wrap: wrap; height: 100%;">
...
void setup(){
  ...
  char* senha = "rc-vespa"; // senha da rede (no minimo 8 caracteres)
